...
INSERT INTO Médicos(idMédicos, Nombre, Especialidad, telefono) VALUES
(1, 'Dr. Juan Pérez', 'Cardiología', '555-1001'),
(2, 'Dra. Ana López', 'Neurología', '555-1002'),
(3, 'Dr. Carlos Gómez', 'Pediatría', '555-1003'),
(4, 'Dr. María Fernández', 'Dermatología', '555-1004'),
(5, 'Dra. Rosa Sánchez', 'Traumatología', '555-1005'),
(6, 'Dr. Luis Ortiz', 'Oncología', '555-1006', '2020-11-18'),
(7, 'Dra. Beatriz Ruiz', 'Endocrinología', '555-1007'),
(8, 'Dr. Pedro Méndez', 'Psiquiatría', '555-1008'),
(9, 'Dra. Silvia Gutiérrez', 'Ginecología', '555-1009'),
(10, 'Dr. Andrés Robles', 'Urología', '555-1010'),
(11, 'Dr. Javier Castro', 'Hematología', '555-1011'),
(12, 'Dr. Miguel Herrera', 'Reumatología', '555-1012'),
(13, 'Dra. Laura Morales', 'Alergología', '555-1013'),
(14, 'Dr. Jorge Vega', 'Neumología', '555-1014'),
(15, 'Dra. Clara Rojas', 'Geriatría', '555-1015'),
(16, 'Dr. Álvaro Torres', 'Cirugía General', '555-1016'),
(17, 'Dra. Patricia Navarro', 'Cirugía Plástica', '555-1017'),
(18, 'Dr. Enrique Ramos', 'Oftalmología', '555-1018'),
(19, 'Dra. Marta Espinosa', 'Otorrinolaringología', '555-1019'),
(20, 'Dr. Manuel Suárez', 'Medicina Interna', '555-1020'),
(21, 'Dra. Daniela Varela', 'Medicina Familiar', '555-1021'),
(22, 'Dr. Adrián Castillo', 'Nefrología', '555-1022'),
(23, 'Dra. Estefanía Flores', 'Cardiología', '555-1023'),
(24, 'Dr. Santiago Luna', 'Neurología', '555-1024'),
(25, 'Dra. Elena Vargas', 'Oncología', '555-1025'),
(26, 'Dr. Gonzalo Aguilar', 'Psiquiatría', '555-1026'),
(27, 'Dra. Liliana Ortiz', 'Endocrinología', '555-1027'),
(28, 'Dr. Rodrigo Salinas', 'Traumatología', '555-1028'),
(29, 'Dra. Irene Díaz', 'Dermatología', '555-1029'),
(30, 'Dr. Tomás Romero', 'Pediatría', '555-1030'),
(31, 'Dra. Verónica Álvarez', 'Reumatología', '555-1031'),
(32, 'Dr. Eduardo Peralta', 'Hematología', '555-1032'),
(33, 'Dra. Sofía Mendoza', 'Geriatría', '555-1033'),
(34, 'Dr. Óscar Pacheco', 'Neumología', '555-1034'),
(35, 'Dra. Lorena Valdés', 'Cirugía Plástica', '555-1035'),
(36, 'Dr. Emilio Fuentes', 'Medicina Interna', '555-1036'),
(37, 'Dra. Gabriela Sandoval', 'Ginecología', '555-1037'),
(38, 'Dr. Nicolás Andrade', 'Urología', '555-1038'),
(39, 'Dra. Paula Quintana', 'Alergología', '555-1039'),
(40, 'Dr. Ignacio Bravo', 'Cirugía General', '555-1040'),
(41, 'Dra. Alicia Reyes', 'Oftalmología', '555-1041'),
(42, 'Dr. Sebastián Campos', 'Otorrinolaringología', '555-1042'),
(43, 'Dra. Teresa Calderón', 'Medicina Familiar', '555-1043'),
(44, 'Dr. Fernando Silva', 'Nefrología', '555-1044'),
(45, 'Dra. Valeria Prieto', 'Cardiología', '555-1045'),
(46, 'Dr. Ricardo Maldonado', 'Neurología', '555-1046'),
(47, 'Dra. Mariana Figueroa', 'Dermatología', '555-1047'),
(48, 'Dr. Arturo Flores', 'Psiquiatría', '555-1048'),
(49, 'Dra. Alejandra Peña', 'Oncología', '555-1049'),
(50, 'Dr. Teresa Morales', 'Geriatría', '555-1050');
COMMIT;
...
(1, 'Pedro Sánchez', '1980-05-20', '555-2321',  'Hipertensión', 'Presión arterial alta'),
(2, 'Lucía Méndez', '1995-03-15', '555-2002',  'Migraña', 'Dolores de cabeza severos'),
(3, 'Marcos Rivera', '1978-07-09', '555-2003', 3, 'Asma', 'Dificultad para respirar'),
...
INSERT INTO medicamentos(idMedicamentos,nombre, descripcion, Pacientes_idPacientes, idMédicos) VALUES
(1, 'Paracetamol', 'Analgésico y antipirético', 1,1),
(2, 'Ibuprofeno', 'Antiinflamatorio no esteroideo', 2,2),
(3, 'Amoxicilina', 'Antibiótico de amplio espectro', 3,3),
(4, 'Loratadina', 'Antihistamínico para alergias', 4,4),
(5, 'Metformina', 'Regula niveles de glucosa', 5,5),
(6, 'Levotiroxina', 'Tratamiento para hipotiroidismo', 6,6),
(7, 'Omeprazol', 'Protector gástrico', 7,7),
(8, 'Salbutamol', 'Broncodilatador', 8,8),
(9, 'Enalapril', 'Control de presión arterial', 9,9),
(10, 'Diclofenaco', 'Antiinflamatorio para dolores', 10,10),
(11, 'Simvastatina', 'Controla el colesterol', 11,11),
(12, 'Ranitidina', 'Reductor de ácido estomacal', 12,12),
(13, 'Prednisona', 'Corticosteroide para inflamaciones', 13,13),
(14, 'Alprazolam', 'Trastornos de ansiedad', 14,14),
(15, 'Clonazepam', 'Control de convulsiones', 15,15),
(16, 'Insulina', 'Control de diabetes tipo 1', 16,16),
...
SELECT 
    ...
    COUNT(Recetas.idRecetas) AS veces_recetado
FROM 
    Recetas
JOIN 
    Medicamentos ON Recetas.Medicamentos_idMedicamentos = Medicamentos.idMedicamentos
GROUP BY 
    Medicamentos.idMedicamentos, Medicamentos.nombre
ORDER BY 
    veces_recetado DESC;
